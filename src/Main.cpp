...
int main(void)
{
	...
	otos->setLinearScalar(1.045f); // This should be 1.0f, but we found that 1.04f gives better position tracking, likely to compensate for some scaling issue with the sensor measurements
